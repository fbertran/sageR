...
vignette: >
  %\VignetteIndexEntry{Chapitre 08. Introduction à la théorie des probabilités aux distributions statistiques classiques.}
...
```{r, eval=LOCAL, cache=TRUE, message=FALSE, warning=FALSE}
...
```{r, eval=LOCAL, cache=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
